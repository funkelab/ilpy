...
class LinearConstraint:
    def set_coefficient(self, i, value) -> None: ...
    def get_coefficients(self) -> None: ...
    def set_relation(self, relation) -> None: ...
    def set_value(self, value) -> None: ...
    def get_relation(self) -> None: ...
    def get_value(self) -> None: ...
    def is_violated(self, solution: Solution) -> None: ...
...
class LinearSolver(_Solver):
    def set_objective(self, objective: LinearObjective): ...
